...
<body class="bg-gray-100">
    <header class="bg-blue-800 text-white flex justify-between items-center px-5 py-4">
        <h1 class="text-2xl font-bold">Agregar Servicios</h1>
    ...
    <div class="flex">
        ...
        <div class="flex-grow p-5">
            <h2 class="mb-4 text-2xl font-semibold">Agregar Nuevo Servicio</h2>
            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
                @csrf

                <!-- Nombre -->
                <div class="form-group">
                    <label for="nombre" class="block text-gray-700">Nombre del Servicio</label>
                ...
                <!-- Botón de envío -->
                <button type="submit" class="w-full bg-blue-600 text-white font-bold py-2 rounded-lg hover:bg-blue-700 transition duration-200">Agregar Servicio</button>
            </form>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#menu-toggle').click(function() {
                $('#menu').toggleClass('transform -translate-x-full md:translate-x-0');
            });
        });
    </script>
</body>
